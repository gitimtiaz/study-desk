      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-dark relative overflow-hidden p-14">
        ...
        <div className="flex flex-col gap-3 relative z-10">
          {[
            ...
            'JWT secured with HTTP-only cookies',
...
function ErrorDotIcon() {
  return <span className="w-1 h-1 rounded-full bg-red-500 inline-block shrink-0 mt-0.5" />
}
function GoogleIcon() {
  return (
