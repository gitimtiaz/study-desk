...
export default function RegisterPage() {
  ...
  const handleGoogle = () => {
    // wire to BetterAuth Google 
    toast('Google login coming.', { icon: '🔧' })
  }
    ...
    <div className="flex min-h-[calc(100vh-64px)]">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[42%] bg-dark relative overflow-hidden p-14">
        ...
        <div className="relative z-10">
          <span className="block font-heading text-primary/30 leading-none select-none"
            style={{ fontSize: '7rem' }}>"</span>
          ...
          <p className="text-cream/35 text-sm mt-4 tracking-widest uppercase">
            — StudyDesk
          </p>
        </div>
        ...
        {/* Bottom: what you get */}
        <div className="relative z-10">
          <p className="text-xs uppercase tracking-[0.15em] text-primary/60 mb-4">
            What you get
          </p>
          <div className="flex flex-col gap-3">
            {[
              'Access to 50+ private study rooms',
              'Real-time conflict-free booking',
              'Your own room listings dashboard',
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-7">
            ...
            <p className="text-sm text-base-content/55">
              Join StudyDesk and start booking in minutes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl text-sm bg-base-200 border text-base-content placeholder:text-base-content/35 outline-none transition-all duration-200 focus:border-primary focus:ring-2 focus:ring-primary/20 ${
                  errors.name ? 'border-red-400' : 'border-base-300'
                }`}
              />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl text-sm bg-base-200 border text-base-content placeholder:text-base-content/35 outline-none transition-all duration-200 focus:border-primary focus:ring-2 focus:ring-primary/20 ${
                  errors.email ? 'border-red-400' : 'border-base-300'
                }`}
              />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className={`flex-1 px-4 py-3 rounded-xl text-sm bg-base-200 border text-base-content placeholder:text-base-content/35 outline-none transition-all duration-200 focus:border-primary focus:ring-2 focus:ring-primary/20 ${
                    errors.photoURL ? 'border-red-400' : 'border-base-300'
                  }`}
                />
              </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-11 rounded-xl text-sm bg-base-200 border text-base-content placeholder:text-base-content/35 outline-none transition-all duration-200 focus:border-primary focus:ring-2 focus:ring-primary/20 ${
                    errors.password ? 'border-red-400' : 'border-base-300'
                  }`}
                />
                    ...
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i}
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                          strength.score >= i ? strength.color : 'bg-base-300'
                        }`}
                      />
                    ))}
                  </div>
                ...
                <div className="flex flex-col gap-1 mt-1">
                  {requirements.map((r) => (
                    <div key={r.label} className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${r.met ? 'text-green-500' : 'text-base-content/40'}`}>
                      {r.met ? <CheckCircleIcon /> : <DotCircleIcon />}
                      {r.label}
                    </div>
                  ))}
                </div>
...
function FieldError({ msg }) {
  return (
    <p className="text-xs text-red-500 flex items-center gap-1">
      <span className="w-1 h-1 rounded-full bg-red-500 inline-block shrink-0 mt-0.5" />
      {msg}
    </p>
  )
}
...
function BookIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF8303" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function CheckIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FF8303" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
function PersonIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-base-content/30">
